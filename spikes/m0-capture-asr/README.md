...
De-risking spike for [ADR-0017](../../docs/adr/0017-voice-and-meeting-transcription.md)
...
Windows WASAPI). That is the platform half of ADR-0017 §1 and belongs to plan **M2**;
...
## 5. The Parakeet comparison (ADR-0017 Q5)

ADR-0017 locked "sherpa-onnx/Parakeet" expecting *true streaming*. **Finding from
...
zipformer's accuracy is acceptable, the "true streaming" wording in ADR-0017 §2/Q5
